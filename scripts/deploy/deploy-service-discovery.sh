...
echo "🚀 Deploying Eureka Service Discovery using infrastructure deployment script..."
cd "$PROJECT_ROOT" && ./infrastructure/scripts/deploy/deploy-service-discovery.sh
